...
class st extends Application {
  ...
  getData() {
    ...
    const n = this.library.getOrderedFavorites().map((f) => {
      var y, T, v, A;
      const g = f.type === "track" ? ((T = (y = window.ASE) == null ? void 0 : y.queue) == null ? void 0 : T.hasItem(f.id)) ?? !1 : ((A = (v = window.ASE) == null ? void 0 : v.queue) == null ? void 0 : A.getItems().some((b) => b.playlistId === f.id)) ?? !1;
      if (f.type === "track") {
  ...
  getItemViewData(t) {
    var l, c, u, m, p;
    const e = ((c = (l = window.ASE) == null ? void 0 : l.queue) == null ? void 0 : c.hasItem(t.id)) ?? !1, i = L(t.duration), s = (p = (m = (u = window.ASE) == null ? void 0 : u.engine) == null ? void 0 : m.getTrack) == null ? void 0 : p.call(m, t.id), r = (s == null ? void 0 : s.state) === "playing", n = (s == null ? void 0 : s.state) === "paused";
    return {
      id: t.id,
      name: t.name,
      url: t.url,
  ...
  async onToggleFavorite(t) {
    ...
    const e = $(t.currentTarget), i = e.closest("[data-item-id]").data("item-id");
    try {
      const n = e.find("i");
      n.hasClass("far") ? (n.removeClass("far").addClass("fas active"), e.addClass("active")) : (n.removeClass("fas active").addClass("far"), e.removeClass("active")), this.persistScroll();
      const l = this.library.toggleFavorite(i);
      this.render(), (s = ui.notifications) == null || s.info(l ? "Added to favorites" : "Removed from favorites");
    } catch (n) {
      ...
      for (const g of l.sounds) {
        ...
        if (A)
          ...
          try {
            ...
            A = (await this.library.addItem(y, g.name, v, b)).id, m++;
          } catch (b) {
...
class N extends ot(nt) {
  ...
  async _prepareContext(t) {
    const e = this.engine.volumes, i = (n) => {
      ...
      const c = l.some((m) => m.state === "playing"), u = l.some((m) => m.state === "paused");
...
Hooks.once("init", () => {
  o.info("Initializing Advanced Sound Engine..."), vt(), ft();
});
Hooks.once("ready", async () => {
  var a;
  const d = ((a = game.user) == null ? void 0 : a.isGM) ?? !1;
  o.info(`Starting Advanced Sound Engine (${d ? "GM" : "Player"})...`), P = new it(), d ? await mt() : await pt(), U = new ht(), window.ASE = {
    isGM: d,
    openPanel: d ? B : gt,
...
//# sourceMappingURL=advanced-sound-engine.js.map
